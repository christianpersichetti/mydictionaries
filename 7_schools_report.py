...
for school in schools:
    if school["NCAA"]["NAIA conference number football (IC2020)"] in conference_schools:
        if school["Graduation rate  women (DRVGR2020)"] > 80:
            ...
            print(
                f"Graduation Rate for Women: {['Graduation rate  women (DRVGR2020)']}"
            )
            print()
            print()

# Display report for all universities that have a total price for in-state students living off campus over $50,000
for prices in schools:
    if prices["NCAA"]["NAIA conference number football (IC2020)"] in conference_schools:
        if (
            prices[
            ...
            print(f"University Name: {prices['instnm']}")
            print(
                f"Total price for in-state students living off campus: {prices['Total price for in-state students living off campus (not with family 2020-21 (DRVIC2020)']}"
            )
            print()
            print()
